...
public class ReadDataSheet {
	...
	public String getValue(String SheetName, String className, String columnHeader) throws Exception {
		...
		try {
			FileInputStream file = new FileInputStream(new File("./Grip_Process.xls"));
	...
	public String getSetUpValue(String SheetName, String className, String columnHeader) throws Exception {
